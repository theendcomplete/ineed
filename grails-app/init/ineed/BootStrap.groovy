...
//        String email
            ...
            new Item(item_name: "Ручка шариковая любая", quantity: "3", store: "Комус", reason: "Подписывать крайне важные документы, 2 штуки", user: jane, item_status: "New").save()
            new Item(item_name: "Картридж Brother hl 5250", store: "Комус", quantity: "3", reason: "В пигментную, печатат", user: admin, item_status: "New").save()
